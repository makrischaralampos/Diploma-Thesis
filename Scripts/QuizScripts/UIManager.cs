...
public class UIManager : MonoBehaviour
{
    ...
    void UpdateResUI (ResolutionScreenType type, int score)
    {
        ...
        switch (type)
        {
            case ResolutionScreenType.Correct:
                ...
                uIElements.ResolutionStateInfoText.text = "”Ÿ”‘œ!";
                uIElements.ResolutionScoreText.text = "+" + score;
                break;
            case ResolutionScreenType.Incorrect:
                uIElements.ResolutionBG.color = parameters.IncorrectBGColor;
                uIElements.ResolutionStateInfoText.text = "À¡Õ»¡”Ã≈Õœ!";
                uIElements.ResolutionScoreText.text = "-" + score;
                break;
            case ResolutionScreenType.Finish:
                uIElements.ResolutionBG.color = parameters.FinalBGColor;
                uIElements.ResolutionStateInfoText.text = "‘≈À… œ ” œ—!";

                StartCoroutine(CalculateScore());
                uIElements.FinishUIElements.gameObject.SetActive(true);
                uIElements.HighScoreText.gameObject.SetActive(true);
                uIElements.HighScoreText.text = ((highscore > events.StartupHighscore) ? "<color=yellow>Ì›· </color>" : string.Empty) + "’¯ÁÎﬁ ¬·ËÏÔÎÔ„ﬂ·: " + highscore;
                break;
        }
    }

    /// <summary>
    /// Function that is used to display and calculate the score.
    /// </summary>
    ...
    void UpdateScoreUI ()
    {
        uIElements.ScoreText.text = "”ÍÔÒ: " + events.CurrentFinalScore;
    }
}
